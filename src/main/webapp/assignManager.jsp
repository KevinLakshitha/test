...
<h1 style="text-align: center;"><span style="color:#3399ff;"><strong>Assign a New Manager to the System</strong></span></h1>
<center>
...
<br>
 ...
 <center> <img src="assets/images/avatar.jpg" alt="Avatar" style="width:90px"> </center>
...
<div class="formboader">
  ...
  <form action="assign" method="post"><center>
   ...
   <input class="text" type="text" name="nic" placeholder="Enter NIC"><br>
   
      <input class="text" type="text" name="name" placeholder="Enter Name"><br>

   <input class="text" type="text" name="email" placeholder="Enter E mail"><br>
   
   <input class="text" type="text" name="phoneno" placeholder="Enter Phone No">
   <br>
      <br>
      
      
      <h1 style="text-align: center;"><span style="color:#3399ff;"><strong>Select Manager Type</strong></span></h1>	
    <br>
      <br>
...
<br>
  ...
  <a href="assignManager.jsp"> <input type="submit" name="submit"  value="Assign Manager"> </a>
...
<h3 style="text-align: center;"><span style="color:#27ae60;"><strong>Direx Tourism</strong></span></h3>
