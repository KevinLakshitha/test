...
<p><span style="font-family:Arial,Helvetica,sans-serif;"><center>W E L C O M E</center></span></p>
<br>
<h2 style="line-height: 45px" ><font face="Arial"  style="color: white"><center>Admin Login</center></font></h2>
<br>
<br>
...
<div class="formboader">
  <form action="neww" method="post"><center>
    
    
    <input type="text" name="adminid" placeholder="Enter Admin ID" ><br>
    
   <input class="pw" type="password" name="adminPw" placeholder="Enter Password"><br>
...
<p><span style="font-family:Arial,Helvetica,sans-serif;"><center>Forgot Password</center></span></p>
