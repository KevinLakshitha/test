...
<h4 style="text-align: center;"><span style="color:#3399ff;"><strong>Search Managers by Manager ID</strong></span></h4>


       
         
   <form action="search" method="post" onSubmit="return validateSearch()"><center>
   
   


   <input type="text" name="managerID" placeholder="Enter Manager ID" ><br>
...
<div class="formboader">
  ...
  <form action="assign" method="post"><center>
    <h4 style="text-align: center;"><span style="color:#3399ff;"><strong>Manager Information</strong></span></h4>
    
    <input type="text" name="managerID" placeholder="Manager ID" required ><br>
    
   <input class="text" type="text" name="nic" placeholder="NIC" required><br>
   
      <input class="text" type="text" name="name" placeholder="Name" required><br>

   <input class="text" type="email" name="email" placeholder="E mail" required><br>
   
   <input class="text" type="text" name="phoneno" placeholder="Phone No" required>
   <br>
      <br>
      
      
      <h4 style="text-align: center;"><span style="color:#3399ff;"><strong>Manager Type</strong></span></h4>	
    <br>
      <br>
...
<div class="box">
  <select id="section" name="section">
    ...
    <option value="Foreign Tour Manager">Foreign Tour Manager</option>
    <option value="Ticket Booking Manager">Ticket Booking Manager</option>
 ...
 <input type="submit" class="b" name="submit"  value="Assign New Manager"> 
<br>
